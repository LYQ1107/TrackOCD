...
def main() -> None:
    ...
    key_paths = [OUT / "metrics/temporal_mean_full.json", OUT / "audit/physical_r_q0_q0_parity_v5_adapter.json", OUT / "audit/physical_r_temporal_comparison_v2.json", OUT / "audit/physical_r_selective_comparison.json", OUT / "metrics/support_event_replay.json", OUT / "metrics/support_event_replay_selective_source_v1.json", OUT / "metrics/support_event_replay_raw_defer_v1.json", OUT / "audit/support_alignment_feasibility.json", OUT / "audit/event_physical_contamination.json", OUT / "audit/leakage_contract.json"]

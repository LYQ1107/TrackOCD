...
def main() -> None:
    status = {
        ...
        "artifact_hashes": {name: sha(OUT / rel) for name, rel in {"physical_temporal": "metrics/physical_r_temporal_comparison_v2.json", "physical_selective": "metrics/physical_r_selective_comparison.json", "support": "metrics/support_event_replay.json", "support_selective_source": "metrics/support_event_replay_selective_source_v1.json"}.items()},

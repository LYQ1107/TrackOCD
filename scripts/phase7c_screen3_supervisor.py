"""Third screening wave: episodic-hard targets restored, 16-dim features."""
...
JOBS = [
    ("outputs/iclr27_phase7c/training/screen3_ce16",
     ["--mode", "hard", "--epochs", "10", "--m-kp", "0", "--m-open", "0",
      "--w-kp", "0", "--w-open", "0"], 1),
    ("outputs/iclr27_phase7c/training/screen3_kp16",
     ["--mode", "hard", "--epochs", "10", "--m-kp", "0.5", "--m-open", "0.5",

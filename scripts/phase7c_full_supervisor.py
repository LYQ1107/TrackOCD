"""Phase 7C full training: KPOC-main (hard) + random-split ablation."""
...
JOBS = [
    ("outputs/iclr27_phase7c/training/kpoc_main",
     ["--mode", "hard", "--epochs", "30", "--m-kp", "0", "--m-open", "0",
      "--w-kp", "0", "--w-open", "0"], 1),
    ("outputs/iclr27_phase7c/training/kpoc_abl_random",
     ["--mode", "random", "--epochs", "30", "--m-kp", "0", "--m-open", "0",
      "--w-kp", "0", "--w-open", "0"], 4),
]
...
def main():
    ...
    print("PHASE7C_FULL_DONE", flush=True)

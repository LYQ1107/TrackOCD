...
def run_stream(ckpt:Path, device:str, max_videos=None, use_motion: bool = False, max_miss: int = 8, use_appearance: bool = False, geometry: bool = False, geometry_conservative: bool = False):
    import torch
    ...
    if geometry:
        runtime=CausalGeometryRuntime(max_miss=int(max_miss), max_tracks=512, conservative=geometry_conservative)
    else:

...
p3=$!
CUDA_VISIBLE_DEVICES=4 $P -u src/orbit_msr/train.py --variant T2 --weight_new 2 \
  --epochs 40 --episodes_per_epoch 12 --output_dir msr_t2 > runs/orbit_msr/train_t2.log 2>&1 &
p4=$!

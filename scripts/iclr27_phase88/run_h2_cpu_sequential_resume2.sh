...
run_resume() {
  local fold="$1"
  local source="$2"
  local tag="h2_known_suppression_cpu_resume2_f${fold}"
...
run_resume 0 "$CKPT/h2_known_suppression_cpu_formal_f0_step024000.pt"
run_resume 1 "$CKPT/h2_known_suppression_cpu_formal_f1_step022000.pt"
run_resume 2 "$CKPT/h2_known_suppression_cpu_formal_f2_step020000.pt"
run_resume 3 "$CKPT/h2_known_suppression_cpu_formal_f3_step022000.pt"
echo "H2_CPU_SEQUENTIAL_RESUME2_COMPLETE"

...
def main() -> None:
    ...
    required = [
        ...
        ROOT / "docs" / "iclr27_phase88" / "PHASE87_AUTONOMOUS_RESEARCH_REPORT.md",
    ]
    ...
    for proc in pathlib.Path("/proc").glob("[0-9]*"):
        try:
            ...
            continue
        if "iclr27_phase88" in cmd and "integrity_check.py" not in cmd:
    ...
    payload = {
        ...
        "checkpoint_root_exists": pathlib.Path("/data2/usr_for_deadline/trackocd_phase88/project_outputs/checkpoints").exists(),

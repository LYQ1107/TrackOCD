"""Fragmentation vs semantic continuity audit.

For each GT track, collect the predicted physical IDs that cover it
(IoU>=0.5 per frame).  If a GT track is covered by >1 predicted ID
(fragmented), report whether the fragments keep the same semantic
identity in the frame-online semantic logs.
"""
